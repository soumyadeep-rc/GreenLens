...
export default function NGOPartnershipPage() {
  return (
    ...
    <motion.div
      className="min-h-screen w-full from-[#A5D6A7] to-[#E8F5E9] bg-gradient-to-b flex items-center py-20"
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Button */}
            <a href="mailto:soumyadeeproychowdhury101@gmail.com"> { }
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                transition={{ type: 'spring', stiffness: 200 }}
                // ✅ FIX: Changed bg-linear-to-r to bg-gradient-to-r
                className="h-14 px-8 bg-gradient-to-r from-emerald-900 to-green-950 text-white rounded-2xl flex items-center justify-center gap-2 shadow-lg"
              >
                <Mail />
          ...
          {/* RIGHT IMAGE */}
          <motion.div
            className="h-[500px] w-full mt-12 rounded-3xl shadow-[2px_2px_10px_rgba(0,0,0,0.4)]"
            style={{
